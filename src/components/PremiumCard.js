...
function PremiumCard({ name, Offer, Features, duration, price, mrp }) {
  return (
    <div>
      <div className="h-[280px] cursor-pointer relative bg-custom-radial w-[450px]  rounded-2xl border-[3px] border-[#A58950] flex  flex-col justify-between">
        <div>
          <span className="absolute right-4 top-3 bg-gold/40 px-2">
            {Offer}
          </span>
